...
const notesState: NotesState = {
    ...
    isCreating: false,
    view: 'LIST',
    currentNoteState: initialNotes[0] ? {
            title: initialNotes[0].title,
            tags: initialNotes[0].tags.join(','),
...
export const NotesProvider = ({children}: { children: ReactNode }) => {
    ...
    const filteredNotes = getFilteredNotes(state.initialNotes, state.filter);
    ...
    return (
        <NotesContext.Provider value={{
            ...
            view: state.view,
            currentNoteState: state.currentNoteState,
            dispatch
        }}>
            {children}
